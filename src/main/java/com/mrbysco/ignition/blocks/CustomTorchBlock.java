...
public class CustomTorchBlock extends TorchBlock implements Inferno {
	...
	public CustomTorchBlock(Properties properties, ParticleOptions options, Supplier<Block> fireBlockSupplier,
