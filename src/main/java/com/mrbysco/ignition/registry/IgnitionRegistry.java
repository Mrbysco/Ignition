...
public class IgnitionRegistry {
	...
	public static final RegistryObject<Item> TORCH_ITEM = ITEMS.register("torch", () -> new StandingAndWallBlockItem(TORCH.get(), WALL_TORCH.get(), new Item.Properties(), Direction.DOWN));
	public static final RegistryObject<Item> SOUL_TORCH_ITEM = ITEMS.register("soul_torch", () -> new StandingAndWallBlockItem(SOUL_TORCH.get(), SOUL_WALL_TORCH.get(), new Item.Properties(), Direction.DOWN));
	public static final RegistryObject<Item> CANDLE_ITEM = ITEMS.register("candle", () -> new BlockItem(CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> WHITE_CANDLE_ITEM = ITEMS.register("white_candle", () -> new BlockItem(WHITE_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> ORANGE_CANDLE_ITEM = ITEMS.register("orange_candle", () -> new BlockItem(ORANGE_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> MAGENTA_CANDLE_ITEM = ITEMS.register("magenta_candle", () -> new BlockItem(MAGENTA_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> LIGHT_BLUE_CANDLE_ITEM = ITEMS.register("light_blue_candle", () -> new BlockItem(LIGHT_BLUE_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> YELLOW_CANDLE_ITEM = ITEMS.register("yellow_candle", () -> new BlockItem(YELLOW_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> LIME_CANDLE_ITEM = ITEMS.register("lime_candle", () -> new BlockItem(LIME_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> PINK_CANDLE_ITEM = ITEMS.register("pink_candle", () -> new BlockItem(PINK_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GRAY_CANDLE_ITEM = ITEMS.register("gray_candle", () -> new BlockItem(GRAY_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> LIGHT_GRAY_CANDLE_ITEM = ITEMS.register("light_gray_candle", () -> new BlockItem(LIGHT_GRAY_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> CYAN_CANDLE_ITEM = ITEMS.register("cyan_candle", () -> new BlockItem(CYAN_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> PURPLE_CANDLE_ITEM = ITEMS.register("purple_candle", () -> new BlockItem(PURPLE_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> BLUE_CANDLE_ITEM = ITEMS.register("blue_candle", () -> new BlockItem(BLUE_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> BROWN_CANDLE_ITEM = ITEMS.register("brown_candle", () -> new BlockItem(BROWN_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GREEN_CANDLE_ITEM = ITEMS.register("green_candle", () -> new BlockItem(GREEN_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> RED_CANDLE_ITEM = ITEMS.register("red_candle", () -> new BlockItem(RED_CANDLE.get(), new Item.Properties()));
	public static final RegistryObject<Item> BLACK_CANDLE_ITEM = ITEMS.register("black_candle", () -> new BlockItem(BLACK_CANDLE.get(), new Item.Properties()));
}
